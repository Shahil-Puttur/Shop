...
// This is a professional-grade CORS setup. It explicitly allows your Netlify app.
const whitelist = ['https://cafe-rite.netlify.app', 'http://localhost:5500', 'http://127.0.0.1:5500'];
const corsOptions = {
...
// The check endpoint is now the pre-warm and cooldown check
app.post('/check', async (req, res) => {
    ...
    try {
        ...
        const result = await client.query('SELECT timestamp FROM recent_plays WHERE fingerprint = $1', [fingerprint]);
...
app.get('/viewers', async (req, res) => { /* ... same as before ... */ });
