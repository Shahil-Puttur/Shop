...
async function initializeDatabase() {
    ...
    try {
        ...
        // The new, powerful recent_plays table
        await client.query(`
...
// The play endpoint is now the fortress gatekeeper
app.post('/play', async (req, res) => {
    const { boxIndex, deviceId, phoneNumber } = req.body;
    if (boxIndex === undefined || !deviceId || !phoneNumber) {
    ...
    try {
        ...
        // Unbreakable check: Has this device OR this phone number played?
        ...
        await client.query('INSERT INTO recent_plays (device_id, phone_number, timestamp) VALUES ($1, $2, NOW())', [deviceId, phoneNumber]);
