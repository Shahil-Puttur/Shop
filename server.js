...
// This explicitly tells the server who is on the VIP list.
const corsOptions = {
  origin: 'https://cafe-rite.netlify.app', // Your exact Netlify URL
...
app.get('/', (req, res) => res.send('<h1>Cafe Rite Backend is live and healthy!</h1>'));
