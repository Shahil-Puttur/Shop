...
// The database is now simple: only one table.
...
// The /play endpoint is now simple and unbreakable. It does not check deviceId.
...
// The reset link now only needs to reset the play count.
